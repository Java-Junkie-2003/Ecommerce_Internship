          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <div className="grid flex-1 text-left leading-tight">
                <span className="truncate font-bold text-base text-sidebar-foreground group-hover/user:text-sidebar-accent-foreground transition-colors">{user.name}</span>
                <span className="truncate text-xs text-sidebar-muted-foreground font-medium">{user.email}</span>
              </div>
          ...
          >
            <DropdownMenuLabel className="p-0 font-normal">
              <div className="flex items-center gap-4 px-4 py-4 text-left border-b border-gray-100">
                <div className="grid flex-1 text-left leading-tight">
                  <span className="truncate font-bold text-base text-gray-900">{user.name}</span>
                  <span className="truncate text-sm text-gray-600 font-medium">{user.email}</span>
                </div>
              </div>
            </DropdownMenuLabel>
            <div className="p-3">
